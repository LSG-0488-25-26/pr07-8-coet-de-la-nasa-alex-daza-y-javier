// kotlin
                        ...
                        class VideojuegoViewModel(application: Application) : AndroidViewModel(application) {
                            ...
                            init {
                                // Observamos la DB y actualizamos la LiveData para soporte offline
                            ...
                            fun cargarVideojuegos() {
                                ...
                                viewModelScope.launch(Dispatchers.IO) {
                                    try {
                                        // Timeout para evitar quedar colgado indefinidamente
                                        ...
                                        // Persistir en BD para offline (inserción en lote)
                                        ...
                                        // Actualizamos la UI con datos de red (la DB también los emitirá)
                                        _videojuegos.postValue(mapped)
                                    } catch (e: Exception) {
